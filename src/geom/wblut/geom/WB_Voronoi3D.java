...
class WB_Voronoi3D extends WB_Voronoi2D {
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3D(final WB_CoordCollection points, final WB_AABB aabb,
			final WB_ScalarParameter d) {
		return getVoronoi3D(points, points.size(), aabb, d);
	}
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3D(final WB_CoordCollection points, int nv, final WB_AABB aabb,
			final WB_ScalarParameter d) {
		nv = Math.min(nv, points.size());
		if (nv <= 4) {
			return getVoronoi3DBruteForce(points, nv, aabb, d);
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3D(final WB_CoordCollection points, final int nv, final WB_AABB aabb,
			final double d) {
		return getVoronoi3D(points, nv, aabb, new WB_ConstantScalarParameter(d));
	}
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3D(final WB_CoordCollection points, final int nv,
			final WB_AABB aabb) {
		return getVoronoi3D(points, nv, aabb, new WB_ConstantScalarParameter(0));
	}
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3DBruteForce(final WB_CoordCollection points, int nv,
			final WB_AABB aabb, final WB_ScalarParameter d) {
		nv = Math.min(nv, points.size());
		final int n = points.size();
		final List<WB_VoronoiCell3D> result = new FastList<WB_VoronoiCell3D>();
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3DBruteForce(final WB_CoordCollection points, final int nv,
			final WB_AABB aabb, final double d) {
		return getVoronoi3DBruteForce(points, nv, aabb, new WB_ConstantScalarParameter(d));
	}
	 ...
	 * @return
	 */
	public static List<WB_VoronoiCell3D> getVoronoi3DBruteForce(final WB_CoordCollection points, final WB_AABB aabb,
			final WB_ScalarParameter d) {
		return getVoronoi3DBruteForce(points, points.size(), aabb, d);
	}
