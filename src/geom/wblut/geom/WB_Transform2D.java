...
public class WB_Transform2D {
	 ...
	 * @return
	 */
	public WB_Transform2D addFromCSToCS2D(final WB_CoordinateSystem2D CS1, final WB_CoordinateSystem2D CS2) {
	 ...
	 * @return
	 */
	public WB_Transform2D addFromCSToWorld2D(final WB_CoordinateSystem2D CS) {
		WB_CoordinateSystem2D current = CS;
	 ...
	 * @return
	 */
	public WB_Transform2D addFromWorldToCS2D(final WB_CoordinateSystem2D CS) {
	 ...
	 * @return
	 */
	public WB_Transform2D addFromCSToParent2D(final WB_CoordinateSystem2D CS) {
		final WB_CoordinateSystem2D WCS = WB_CoordinateSystem2D.WORLD();
		if (CS.isWorld()) {
			return this;
		}
	 ...
	 * @return
	 */
	public WB_Transform2D addFromParentToCS2D(final WB_CoordinateSystem2D CS) {
		if (CS.isWorld()) {
			return this;
		}
		final WB_Transform2D tmp = new WB_Transform2D();
