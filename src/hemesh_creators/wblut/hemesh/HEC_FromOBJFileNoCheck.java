 ...
 *
 */
public class HEC_FromOBJFileNoCheck extends HEC_Creator {
	 ...
	 * @param path
	 */
	public HEC_FromOBJFileNoCheck(final String path) {
		super();
		this.path = path;
		scale = 1;
		override = true;
	 ...
	 * @return
	 */
	public HEC_FromOBJFileNoCheck setPath(final String path) {
		this.path = path;
		return this;
	}
	 ...
	 */
	@Override
	public HEC_FromOBJFileNoCheck setScale(final double f) {
		scale = f;
		return this;
	}
